...
const Controluser = (data) => {
    ...
    const handleOkAdd = async () => {
        ...
        try {
            ...
            setFormAddDataUser({ fullname: '', username: '', password: '', cid: '', by: '', dept: '', status: '' })
                    ...
                    <div className="card card-white">
                        <div className="card-header">
                            ...
                            <div style={{ textAlign: 'right' }}>
                                <button type="button" className="btn btn-success btn-sm" onClick={showModalAdd}>เพิ่มข้อมูล</button>
                            </div>
                        </div>
