                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-sm-6">
                            <h1 className="m-0">จัดการรายชื่อแผนก</h1>
                        </div>
                        <div className="col-sm-6">
                            <ol className="breadcrumb float-sm-right">
                                <li className="breadcrumb-item" onClick={Home}>หน้าแรก</li>
                                <li className="breadcrumb-item">จัดการรายชื่อแผนก</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="card card-white">
                        <div className="card-header">
                            ...
                            <div style={{ textAlign: 'right' }}>
                                <button type="button" className="btn btn-success btn-sm" onClick={showModalAdd} >เพิ่มแผนก</button>
                            </div>
                        </div>
